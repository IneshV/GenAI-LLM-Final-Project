...
notebooks/Run_all_tests.ipynb
```

Use `notebooks/main_agent_demo_version.ipynb` for the agent demo, tool behavior, document upload workflow, and Gradio UI.

Use `notebooks/Run_all_tests.ipynb` for evaluation experiments, benchmark runs, ablation studies, statistical tests, and generated plots.

## Demo Reproduction

To reproduce the demo:

1. Open `notebooks/main_agent_demo_version.ipynb`.
...
3. Open `notebooks/Run_all_tests.ipynb`.
